...
char* convert(TokenType type)
{
    ...
    case KEYWORD_Ifj: return "KEYWORD_Ifj";
    case KEYWORD_static: return "KEYWORD_static";
    case KEYWORD_import: return "KEYWORD_import";
    case KEYWORD_for: return "KEYWORD_for";
    case KEYWORD_Num: return "KEYWORD_Num";
    case KEYWORD_String: return "KEYWORD_String";
    case KEYWORD_Null: return "KEYWORD_Null";
    case IDENTIFIER_LOCAL: return "IDENTIFIER_LOCAL";
    case IDENTIFIER_GLOBAL: return "IDENTIFIER_GLOBAL";
    case INT: return "INT";
    ...
    case L_ROUND: return "L_ROUND";
    case R_ROUND: return "R_ROUND";
    case L_CURLY: return "L_CURLY";
    case R_CURLY: return "R_CURLY";
    case IFJ_READ_STR: return "IFJ_READ_STR";
    case IFJ_READ_NUM: return "IFJ_READ_NUM";
    case IFJ_WRITE: return "IFJ_WRITE";
    case IFJ_FLOOR: return "IFJ_FLOOR";
    case IFJ_STR: return "IFJ_STR";
    case IFJ_LENGTH: return "IFJ_LENGTH";
    case IFJ_SUBSTRING: return "IFJ_SUBSTRING";
    case IFJ_STRCMP: return "IFJ_STRCMP";
    case IFJ_ORD: return "IFJ_ORD";
    case IFJ_CHR: return "IFJ_CHR";
